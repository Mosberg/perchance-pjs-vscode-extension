...
// EDIT: but then i removed the prompt2 function.
/*
printf '\n' > bundle.js && \
wget -O - "https://cdnjs.cloudflare.com/ajax/libs/dexie/3.2.3/dexie.min.js" >> bundle.js && printf '\n%.0s' {1..10} >> bundle.js && \
wget -O - "https://unpkg.com/dexie-export-import@4.0.6/dist/dexie-export-import.js" >> bundle.js && printf '\n%.0s' {1..10} >> bundle.js && \
...
wget -O - "https://user-uploads.perchance.org/file/aef78f334eaf6d3320fc82fd2bbc04b0.js" >> bundle.js && printf '\n%.0s' {1..10} >> bundle.js
*/
